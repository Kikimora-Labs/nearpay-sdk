...
*/ var OVERLAY_ID = '__parcel__error__overlay__';
    ...
    h7u1C: [
      function (require, module, exports) {
        ...
        parcelHelpers.export(
          exports,
          'makeSignatureString',
          () => _makeSignatureString.makeSignatureString,
        );
        parcelHelpers.export(exports, 'NearPay', () => _nearPay.NearPay);
        parcelHelpers.export(
          exports,
          'isNearpayEvent',
          () => _isNearpayEvent.isNearpayEvent,
        );
        parcelHelpers.export(
          exports,
          'getWidgetUrl',
          () => _getWidgetUrl.getWidgetUrl,
        );
      ...
      {
        './events': '1K5ob',
        './helpers/makeSignatureString': '3JceE',
        './sdk/near-pay': '9DXHi',
        './helpers/isNearpayEvent': 'aYuHq',
        './helpers/getWidgetUrl': '1spVz',
    ...
    '9DXHi': [
      function (require, module, exports) {
        ...
        const ERROR_NO_MOUNT_ELEMENT = new Error(
          '[NearPay]: provide mount element',
        );
        const DEFAULTS = {
...
`;
        ...
        class NearPay {
          ...
          createIframe() {
            ...
            iframe.src = _helpers.getWidgetUrl(
              this._env,
    ...
    hyZmv: [
      ...
      {
        './getWidgetUrl': '1spVz',
        './makeSignatureString': '3JceE',
        './isNearpayEvent': 'aYuHq',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
      },
    ],
    '1spVz': [
